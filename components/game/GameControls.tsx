...
export function GameControls({ onResign, onDraw, onSettings, onNewGame, disabled }: Props) {
  return (
    <div className="flex items-center justify-center gap-1.5 py-2 px-2 md:gap-3 md:py-4 md:px-4">
      <button
        onClick={onResign}
        disabled={disabled}
        className="flex items-center gap-1 px-2.5 py-2 rounded-lg text-xs font-bold tracking-wider
